...
# Labels and title
plt.ylabel('Percentage of mice with metastases [%]', fontsize=16)
...
# Uncomment to save
# plt.savefig("Metastases_full_M0-M3_poster.png", bbox_inches='tight', pad_inches=0.2, dpi=300)
plt.show()
...
# Uncomment to save
# plt.savefig("Macrometastases_vs_Micrometastases_poster.png", bbox_inches='tight', pad_inches=0.2, dpi=300)
plt.show()
